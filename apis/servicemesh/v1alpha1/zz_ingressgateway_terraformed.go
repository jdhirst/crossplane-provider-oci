...
// GetInitParameters of this IngressGateway
func (tr *IngressGateway) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IngressGateway
func (tr *IngressGateway) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
