...
// GetInitParameters of this IngressGatewayRouteTable
func (tr *IngressGatewayRouteTable) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IngressGatewayRouteTable
func (tr *IngressGatewayRouteTable) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
