...
// GetInitParameters of this VirtualDeployment
func (tr *VirtualDeployment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VirtualDeployment
func (tr *VirtualDeployment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
