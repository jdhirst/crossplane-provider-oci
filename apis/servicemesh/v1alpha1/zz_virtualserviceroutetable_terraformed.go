...
// GetInitParameters of this VirtualServiceRouteTable
func (tr *VirtualServiceRouteTable) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VirtualServiceRouteTable
func (tr *VirtualServiceRouteTable) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
